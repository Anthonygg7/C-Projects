...
* Purpose: A retail company must file a monthly sales tax
...
*		   S = T / 1.06
* 
*		   where S is the product sales and T is the total income
*          (product sales plus sales tax).
* 
*          The program should display a report similar to following:
* 
*		     Month: August 2016
*          --------------------
